function ccf_points = RH_histology2ccf(histology_points,slice_im_path)
...
% Robin Haak, Feb '22: load either auto (affine) of manual (projective) tform
...
ccf_alignment_fn = [slice_im_path filesep 'atlas2histology_tform_manual.mat'];
